        ...
        <div class="bg-white rounded-xl border border-stone-200 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-6 border-b border-stone-100">
                ...
                <p class="text-sm text-stone-500 mt-0.5">
                    Create a new CLT layup configuration for {{ $supplier->name }}.
                </p>
            </div>
            ...
            @if(session('success'))
                <div
                    ...
                    class="mx-6 mt-6 flex items-center gap-3 bg-green-50 border border-green-200 text-green-800 text-sm px-4 py-3 rounded-lg"
                >
            ...
            <form action="{{ route('suppliers.layups.store', $supplier) }}"
                ...
                <div>
                    ...
                    <input
                        ...
                        name="name"
                        value="{{ old('name') }}"
                        placeholder="e.g. 5-Layer Standard Birch"
